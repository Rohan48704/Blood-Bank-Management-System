            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">The need for blood</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Welcome friends to our Blood bank management page. We are always at your disposal for help when you require the blood. </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
